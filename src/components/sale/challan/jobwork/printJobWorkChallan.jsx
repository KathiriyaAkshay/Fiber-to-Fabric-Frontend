                ...
                <Flex className="flex-col p-3" ref={componentRef}>
                    ...
                    <div style={{ height: 400 }}>
                        <Row gutter={24} style={{
                            ...
                            <Col span={3} className="text-center"><strong>No</strong></Col>
                            <Col span={7} className="text-center"><strong>Yarn Company</strong></Col>
                            <Col span={6} className="text-center"><strong>Dennier</strong></Col>
                            <Col span={4} className="text-center"><strong>Cartoon</strong></Col>
                            <Col span={4} className="text-center"><strong>KG</strong></Col>
                        </Row>
                        <Row gutter={24} style={{
                            borderTop: "1px dashed",
                            paddingTop: 15,
                            ...
                            <Col span={3}  className="text-center">1</Col>
                            <Col span={7} className="text-center">{details?.yarn_stock_company?.yarn_company_name}</Col>
                            <Col span={6} className="text-center">{`${details?.yarn_stock_company?.yarn_count}C/${details?.yarn_stock_company?.filament}F(${details?.yarn_stock_company?.luster_type}(${details?.yarn_stock_company?.yarn_Sub_type}) - ${details?.yarn_stock_company?.yarn_color})`}</Col>
                            <Col span={4} className="text-center">{details?.quantity}</Col>
                            <Col span={4} className="text-center">{details?.kg}</Col>
                        </Row>
                    </div>
                    <Row gutter={24} style={{
                        borderTop: "1px dashed",
                        ...
                        <Col span={4} className="text-center"><strong>{details?.quantity}</strong></Col>
                        <Col span={4} className="text-center"><strong>{details?.kg}</strong></Col>
                    </Row>
                    ...
                    <Row gutter={24} style={{
                        ...
                        <Col span={4}><strong>{details?.quantity}</strong></Col>
