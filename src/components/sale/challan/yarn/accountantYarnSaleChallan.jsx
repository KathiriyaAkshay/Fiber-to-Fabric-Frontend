...
const AccountantYarnSaleChallan = ({ details }) => {
                ...
                <Flex className="flex-col" ref={componentRef}>
                    ...
                    <Row style={{
                        ...
                        <Col span={12} style={{ textAlign: 'right' }}>
                            <p><strong>CHALLAN NO :</strong> {details?.yarn_sale?.challan_no}</p>
                            <p><strong>DATE :</strong> {moment(details?.yarn_sale?.createdAt).format("DD-MM-YYYY")}</p>
                    ...
                    <Row style={{
                        ...
                        <Col span={4}><strong>{details?.yarn_sale?.yarn_stock_company?.yarn_company_name}</strong></Col>
                    </Row>
                    <div style={{ height: 400 }}>
                        ...
                        <Row gutter={24} style={{
                            ...
                            <Col span={7} style={{textAlign: "center"}}>{String(details?.yarn_sale?.yarn_stock_company?.yarn_company_name).toUpperCase()}</Col>
                            <Col span={6} style={{textAlign: "center"}}>{`${details?.yarn_sale?.yarn_stock_company?.yarn_count}C/${details?.yarn_sale?.yarn_stock_company?.filament}F(${details?.yarn_sale?.yarn_stock_company?.luster_type}(${details?.yarn_sale?.yarn_stock_company?.yarn_Sub_type}) - ${details?.yarn_sale?.yarn_stock_company?.yarn_color})`}</Col>
                            <Col span={4} style={{textAlign: "center"}}>{details?.yarn_sale?.cartoon}</Col>
                            <Col span={4} style={{textAlign: "center"}}>{details?.yarn_sale?.kg}</Col>
                        </Row>
                    </div>
                    <Row gutter={24} style={{
                        borderTop: "1px dashed",
                        ...
                        <Col span={4} style={{textAlign: "center"}}><strong>{details?.yarn_sale?.cartoon}</strong></Col>
                        <Col span={4} style={{textAlign: "center"}}><strong>{details?.yarn_sale?.kg}</strong></Col>
                    </Row>
                    ...
                    <Row gutter={24} style={{
                        ...
                        <Col span={4}><strong>{details?.yarn_sale?.cartoon}</strong></Col>
                        <Col span={4}><strong>TOTAL KG:</strong></Col>
                        <Col span={4}><strong>{details?.yarn_sale?.kg}</strong></Col>
                    </Row>
...
export default AccountantYarnSaleChallan; 