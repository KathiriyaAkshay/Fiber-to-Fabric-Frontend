...
import { deleteDenierwiseWastageReportRequest } from "../../../api/requests/reports/denierwiseWastageReport";

const DeleteDenierwiseWastageReportButton = ({ details }) => {
  ...
  const { mutateAsync: deleteReport } = useMutation({
    mutationFn: async ({ id }) => {
      const res = await deleteDenierwiseWastageReportRequest({
        id,
        params: {
...
export default DeleteDenierwiseWastageReportButton;
