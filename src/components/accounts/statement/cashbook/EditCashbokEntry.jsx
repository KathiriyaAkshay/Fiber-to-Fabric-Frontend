...
import { updateCashbookRequest, updatePassbookRequest } from "../../../../api/requests/accounts/payment";
                                ...
                                <Col span={24}>
                                    ...
                                    >
                                        <Controller
                                            ...
                                            name="amount"
                                            render={({ field }) => {
                                                return <Input value={parseFloat(row?.amount).toFixed(2)} {...field} readOnly={!row?.is_manually_created} />;
                                            }}
                                        />
                                    </Form.Item>
                                </Col>
