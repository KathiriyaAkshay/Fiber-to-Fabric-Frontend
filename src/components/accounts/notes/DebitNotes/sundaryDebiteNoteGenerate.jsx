...
import { getDebitNoteByIdRequest, getLastDebitNoteNumberRequest } from "../../../../api/requests/accounts/notes";
...
const SundaryDebitNoteGenerate = ({ bill_details, companyListRes, open, setOpen, debiteNoteData, setDebitNoteSelection }) => {
    ...
    const manuallyFetchDebitNoteInformation = async () => {
        ...
        const response = await getDebitNoteByIdRequest({ id: debit_note_id, params: params });
                            ...
                            <tr>
                                ...
                                <td colSpan={3} width={"33.33%"}>
                                    <div className="year-toggle" style={{ textAlign: "left" }}>
                                        ...
                                        {isGenerated?<>
                                            {genratedDebiteNoteInfo?.debit_note_details?.map((element) => element?.invoice_no).join(",")}
                                        </>:<>
                    ...
                    <table className="credit-note-table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>-</td>
                                {isGenerated?<>
                                    <td>{genratedDebiteNoteInfo?.debit_note_details?.reduce((total, element) => {
