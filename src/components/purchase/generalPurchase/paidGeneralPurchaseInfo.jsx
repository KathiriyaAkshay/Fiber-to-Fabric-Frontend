...
import { Button, Modal, Typography, Row, Col, Table, Card, Flex, Divider, Tag, Badge, DatePicker } from "antd";
            ...
            >
                ...
                <Row gutter={[16, 16]} style={{ marginTop: 16 }}>
                    <Col span={6}>
                        ...
                        <strong>{moment(details?.invoice_date).format("DD-MM-YYYY")}</strong>
                    </Col>
                    <Col span={6}>
                ...
                <Flex gap={29}>
                            ...
                            summary={() => {
                                return(
                                    <Table.Summary.Row>
                                        ...
                                        <Table.Summary.Cell>{details?.sub_total}</Table.Summary.Cell>
                                        <Table.Summary.Cell>{details?.discount}</Table.Summary.Cell>
                                        <Table.Summary.Cell>0</Table.Summary.Cell>
                                        <Table.Summary.Cell>{details?.sgst_payable}</Table.Summary.Cell>
                                        <Table.Summary.Cell>{details?.cgst_payable}</Table.Summary.Cell>
                    ...
                    <div style={{width: "35%"}}>
                        ...
                        <Row gutter={[16, 16]} style={{ marginTop: 16 }}>
                            ...
                            <Col span={12}>
                                <span>Return Amt. Total</span><br />
                                <strong>0</strong>
                            </Col>
                            <Col span={12}>
                                <span>SGST Payable (%)</span><br />
                                <strong>{details?.main_sgst}</strong>
                            </Col>
                            <Col span={12}>
                                <span>CGST Payable (%)</span><br />
                                <strong>{details?.main_cgst}</strong>
                            </Col>
                            <Col span={12}>
                                <span>Round Of</span><br />
