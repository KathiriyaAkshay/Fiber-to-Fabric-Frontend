      ...
      >
        <div className="container">
          <Card>
            <Row gutter={16}>
              <Col span={8}>
                <strong>Invoice No</strong>: {details?.invoice_no}
              </Col>
              <Col span={8}>
                <strong>Purchase Company</strong>: {"Yarn company"}
              </Col>
              <Col span={8}>
            ...
            <Row gutter={16} style={{ marginTop: 10 }}>
              ...
              <Col span={8}>
                <strong>Grand Total</strong>: {details?.grand_total}
              </Col>
            </Row>
            <Row gutter={16} style={{ marginTop: 10 }}>
              <Col span={8}>
          ...
          <Row gutter={16} style={{ marginTop: 20 }}>
            ...
            <Col span={6}>
              <strong>Final Amount</strong>: {details?.sub_total}
            </Col>
          </Row>
        </div>
                ...
                <Col span={24}>
                  <div>
                    <table style={{ width: "100%" }}>
                      <tbody>
                        <tr
                          style={{ backgroundColor: "#efefef", padding: "4px" }}
                        >
