...
const UpdateYarnChallanModel = ({ details }) => {
    console.log("Bill details information ========================");
    console.log(details);
    ...
    useEffect(() => {
        ...
        if (freight_value !== "" && freight_value !== undefined) {
            let temp_freight_amount = Number(total_amount) + (Number(rate) * Number(totalQuantity));
            setValue("freight_amount", temp_freight_amount.toFixed(2));
        }

        if (is_discount && discount_brokerage_value !== "" && discount_brokerage_value !== undefined) {
            const discountAmount = Number(total_amount) * Number(discount_brokerage_value) / 100;
    ...
    }, [totalQuantity, quantity_rate, watch, setValue, details, freight_value, discount_brokerage_value, SGST_value, CGST_value, IGST_value, TCS_value, TDS_amount]);
                ...
                <Form layout="vertical" onFinish={handleSubmit(onSubmit)}>
                    <Flex className="flex-col border border-b-0 border-solid">
                        <Row className="p-2 border-0 border-b border-solid">
                            ...
                            >
                                <Typography.Text className="font-semibold text-center" style={{ marginTop: "auto", marginBottom: "auto" }}>
                                    :: SHREE GANESHAY NAMAH ::
                                </Typography.Text>
                            </Col>
                        </Row>

                        <Row gutter={24} className="border p-4  !m-0" style={{ borderTop: 0, borderLeft: 0, borderRight: 0 }} >
                            <Col span={4}>
                                Supplier name
                            </Col>
                            <Col span={8}>
                                <Flex>
                                    ...
                                    <Typography.Text style={{ marginTop: "auto", marginBottom: "auto" }}>
                                        <strong>{details?.supplier?.supplier?.supplier_name}</strong>
                                    </Typography.Text>
                                    <Form.Item
                        ...
                        <Row gutter={24} className="border pl-4 pr-4 border-b border-solid !m-0" style={{ borderTop: 0, borderLeft: 0, borderRight: 0, marginTop: -20 }} >
                            <Col span={4}>
                                Company Name
                            </Col>
                            <Col span={8}>
                        ...
                        <Row>
                            ...
                            >
                                <Form.Item
                                    ...
                                    validateStatus={errors.discount_brokerage_value ? "error" : ""}
                                    help={errors.discount_brokerage_value && errors.discount_brokerage_value.message}
                                    required={true}
                                    className="mb-0"
                                >
                                    <Controller
                        ...
                        <Row className="p-2 border border-b border-solid !m-0" style={{ borderLeft: 0, borderRight: 0, borderTop: 0 }}>
