...
import { createJobGraySaleBillRequest } from "../../../../api/requests/sale/bill/jobGraySaleBill";
...
const AddJobGrayBill = () => {
  ...
  const { mutateAsync: addJobGrayBill, isPending } = useMutation({
    mutationFn: async (data) => {
      const res = await createJobGraySaleBillRequest({
        data,
        params: {
    ...
    onSuccess: (res) => {
      queryClient.invalidateQueries(["jobGrayBill", "list"]);
