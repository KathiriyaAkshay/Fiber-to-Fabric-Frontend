        ...
        <Space>
          <GridInformationModel
            ...
            details={[
              {
                label: "Quality name",
                value: `${record?.job_taka_challan?.inhouse_quality?.quality_name} ${record?.job_taka_challan?.inhouse_quality?.quality_weight}KG`,
              },
              {
                label: "Date",
                value: `${moment(record?.job_taka_challan?.createdAt).format(
                  "DD-MM-YYYY"
                )}`,
              },
              ...
              { label: "Order Type", value: "Job" },
              {
                ...
                value: record?.job_taka_challan?.challan_no,
              },
              {
                label: "Supplier Name",
                value: record?.job_taka_challan?.supplier?.supplier_name,
              },
              {
                label: "Purchased Company name",
                value: record?.job_taka_challan?.supplier?.supplier_company,
              },
            ]}
          />
        </Space>
