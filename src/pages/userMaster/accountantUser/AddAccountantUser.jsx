...
const addAccountantUserSchemaResolver = yupResolver(
  yup.object().shape({
...
function AddAccountantUser() {
  ...
  const {
    ...
    resolver: addAccountantUserSchemaResolver,
  });
  ...
  return (
    <div className="flex flex-col p-4">
      <div className="flex items-center gap-5">
        ...
        <h3 className="m-0 text-primary">Add New Accountant User</h3>
      </div>
...
export default AddAccountantUser;
